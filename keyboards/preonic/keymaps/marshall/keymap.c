 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  '   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Vol- | Vol+ |  [[  | Del  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  TD(GR1), KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    TD(MNEQ), KC_BSPC,
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSLS,
  KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_ENT,
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_QUOT,
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_VOLD, KC_VOLU, TD(BRC),  KC_DEL
),
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Left | Down |Right |      |      |  left| down | up   | right| Home | Pg Up|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      | Next | Vol- | Vol+ | Play |      |  Del |  End | Pg Dn|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Left | Down |  Up  | Right|
 * `-----------------------------------------------------------------------------------'
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, KC_1,    KC_UP,   KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
  KC_DEL,  KC_LEFT, KC_DOWN, KC_RIGHT,KC_F4,   KC_F5,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_RBRC, KC_BSLS,
...
[_NUMPAD] = LAYOUT_preonic_grid(
  _______, _______, KC_BTN3, _______, _______, _______, _______, KC_NLCK, KC_SLSH,  KC_ASTR, KC_MINS, KC_BSLS,
